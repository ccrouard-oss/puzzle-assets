// Ultra-light Three.js substitute (compatible Mobirise)
// Forces creation of its own <canvas> and WebGL context

var THREE = {};

THREE.WebGLRenderer = function (params) {
  // always create a <canvas> element
  this.domElement = document.createElement("canvas");
  if (!this.domElement.getContext) {
    throw new Error("Votre navigateur ne supporte pas les canvas HTML5.");
  }
  // Try WebGL context
  this.context =
    this.domElement.getContext("webgl", { antialias: true }) ||
    this.domElement.getContext("experimental-webgl");
  if (!this.context) {
    console.warn("⚠️ WebGL non disponible, rendu désactivé.");
  }
...
Fix WebGLRenderer for Mobirise (force own canvas)
